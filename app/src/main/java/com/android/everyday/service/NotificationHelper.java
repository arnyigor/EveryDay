...
import com.android.everyday.views.activities.TaskActivity;
...
public class NotificationHelper{
	...
	public void sendBasicNotification(Context context, Task task) {
		...
		NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
			...
			.setSmallIcon(Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB ? R.mipmap.ic_launcher : R.drawable.ic_action_settings)
	...
	public void sendPersistentNotification(Context context, Task task) {
		NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
			...
			.setSmallIcon(Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB ?
					R.mipmap.ic_launcher : R.drawable.ic_action_settings)
			.setAutoCancel(true)
			.setContentIntent(getPendingIntent(context,task.getID()))
			.setWhen(System.currentTimeMillis())
			.setOngoing(true)
